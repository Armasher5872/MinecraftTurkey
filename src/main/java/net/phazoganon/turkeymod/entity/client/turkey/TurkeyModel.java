...
public class TurkeyModel<T extends TurkeyRendererState> extends EntityModel<T> {
    public static final MeshTransformer BABY_TRANSFORMER = new BabyModelTransform(Set.of("head", "bill", "dangle"));
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition footl = legl.addOrReplaceChild("footl", CubeListBuilder.create().texOffs(21, 0).mirror().addBox(-1.5F, 0.0F, -2.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.001F)).mirror(false), PartPose.offset(0.0F, 2.0F, 0.0F));
        ...
        PartDefinition footr = legr.addOrReplaceChild("footr", CubeListBuilder.create().texOffs(21, 0).mirror().addBox(-1.5F, 0.0F, -2.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.001F)).mirror(false), PartPose.offset(0.0F, 2.0F, 0.0F));
        ...
        PartDefinition head = torso.addOrReplaceChild("head", CubeListBuilder.create().texOffs(9, 0).addBox(-1.5F, -1.0F, -5.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(29, 0).addBox(-1.5F, -3.0F, -3.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, -7.0F, -4.0F));
